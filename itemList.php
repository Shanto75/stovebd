...
if (!$conn) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['snoEdit'])) {
            ...
            $sql = "UPDATE `items` SET `itemId` = '$id' , `itemName` = '$name' , `price` = '$price' , `description` = '$des' , `photo` = '$imgContent' WHERE `items`.`itemId` = '$id'";
            $result = mysqli_query($conn, $sql);
            if ($result) {
                $update = true;
            } else {
    ...
    <div class="modal fade mx-auto" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog bg-dark text-white" role="document">
            <div class="modal-content bg-dark text-white">
                ...
                <form class="bg-dark mx-auto p-5  text-white " action="itemList.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="menu" class="form-label">Photo</label>
                        <input type="file" class="form-control" name="image" id="editimage" required>
                    </div>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo " <tr>
                        ...
                        <td>
                        <img  style='width: 5rem;' src='data:image/jpg;charset=utf8;base64,". base64_encode($row['photo']) ."' />
                        </td>
                        <td>
