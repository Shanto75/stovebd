    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['snoEdit'])) {
            ...
            if($num != 1){
                ...
                $sql = "UPDATE `info` SET `about` = '$about' , `address` = '$address', `email` = '$email' , `phone` = '$phone' ";
            }
            $result = mysqli_query($conn, $sql);
            if ($result) {
                $update = true;
        ...
        if (!empty($_FILES["img"]["name"])) {
            ...
            if(in_array($fileType, $allowTypes)){ 
                ...
                if($num != 1){
                    ...
                    if($_POST["updatepic"] == "logo"){
                        $sql = "UPDATE `info` SET `logo` = '$imgContent'";
                    }
                    elseif($_POST["updatepic"] == "menu"){
                        $sql = "UPDATE `info` SET `menuPhoto` = '$imgContent'";
                    }
                    elseif($_POST["updatepic"] == "aboutpic"){
                        $sql = "UPDATE `info` SET `aboutpic` = '$imgContent'";
                    }
                }
    ...
    <div class="modal fade mx-auto" id="imgmodal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog bg-dark text-white" role="document">
            <div class="modal-content bg-dark text-white">
                ...
                <form class="bg-dark mx-auto p-5 text-white " action="updateInfo.php" method="post" enctype="multipart/form-data">
                    <h5 class="text-center text-white">Update Image</h5>
    ...
    <div class="container bg-light overflow-auto">
            ...
            <tbody>
                <?php
                    ...
                    echo " <tr>
                        ...
                        <td>" . $row['phone'] . "</td>
                        <td>
                        <button class='update m-1 btn btn-sm btn-primary'>".$btnname."</button>
                        </td>
                        </tr>";
        ...
        <div class="d-flex gap-2">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <button onclick="logo()" class='logo m-1 btn btn-sm btn-primary'><?php echo $btnname; ?></button>
                </div>
            </div>
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <button onclick="menu()" class='menu m-1 btn btn-sm btn-primary'><?php echo $btnname; ?></button>
                </div>
            </div>
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <button onclick="aboutpic()" class='menu m-1 btn btn-sm btn-primary'><?php echo $btnname; ?></button>
                </div>
            </div>
        </div>
